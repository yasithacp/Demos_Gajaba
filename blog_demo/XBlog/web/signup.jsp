...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main"> <span class="tm_bottom"></span>
            <div id="content">   
                <form action="scripts/newusr.jsp" method="post">
                    ...
                    About me: <br/>
                    <textarea name="aboutme" rows="6" cols="30"></textarea><br/><br/>
                    <input style="font-weight: bold;" type="submit" name="submit" id="submit" value="Sign Up"/> <br/><br/>
                    Already a user? <a href="index.jsp">Log In</a>
                </form>
            </div>
