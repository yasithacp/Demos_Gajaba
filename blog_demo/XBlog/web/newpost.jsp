...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="menu_wrapper">
            <div id="menu">
                <ul>
                    <li><a href="#" class="current"><span></span>Sign Up</a></li>
                </ul>
            </div>
        </div>
        <!-- end of menu -->
        ...
        <div id="main"> <span class="tm_bottom"></span>
            <div id="content">   
                <form action="scripts/addpost.jsp" method="post">
                    <font color="red"><%= session.getAttribute("ws_response") == null ? "" : session.getAttribute("ws_response")+" Please try again.<br/><br/>" %></font>
                    Title: <br/>
                    <input type="text" id="user" name="title" size="60" class="newsletter_email" onfocus="clearText(this)" onblur="clearText(this)" /><br/><br/>
                    <textarea name="content" rows="20" cols="82"></textarea><br/><br/>
                    <input style="font-weight: bold;" type="submit" name="submit" id="submit" value="Post"/> <br/><br/>
                </form>
            </div>
